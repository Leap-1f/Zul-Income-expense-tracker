...
export const AddRecordPopUp = ({ setShowAddRecordPopUp }) => {
  ...
  const [isLoadingFetchAllCategoryData, setIsLoadingFetchAllCategoryData] = useState(false);
  ...
  const formikAddRecord = useFormik({
    ...
    onSubmit: async (values) => {
      ...
      values.dateAndTime = values.date + " " + values.time;
      try {
        const selectedCategoryId = await fetch(
          `${process.env.NEXT_PUBLIC_ENDPOINT}/api/select-category-id`,
          {
                ...
                <div className="flex flex-col relative">
                  ...
                  {categoryBox && (
                    <AddRecordCategory
                      ...
                      isLoadingFetchAllCategoryData={isLoadingFetchAllCategoryData}
                    />
                  )}
                </div>
