...
import { MdFastfood, MdHealthAndSafety, MdOfflineBolt, MdNearMe,  MdKitesurfing, MdSavings, MdChildFriendly, MdIcecream, MdFamilyRestroom, MdFitnessCenter } from "react-icons/md";
import { BiSolidDrink } from "react-icons/bi";
import { FaTaxi, FaShoppingCart } from "react-icons/fa";
import { ImAirplane } from "react-icons/im";
import { GiOpenBook } from "react-icons/gi";
import { AiOutlineFileProtect } from "react-icons/ai";
import { ImDroplet, ImEarth, ImFire, ImAttachment, ImClubs, ImHammer, ImHourGlass, ImManWoman, ImMusic, ImPhone, ImStarFull, ImHeart } from "react-icons/im";

export const CategoryIcons = [
  { name: "home", icon: <IoMdHome /> },
  { name: "gift", icon: <IoIosGift /> },
  { name: "food", icon: <MdFastfood /> },
  { name: "drink", icon: <BiSolidDrink /> },
  { name: "taxi", icon: <FaTaxi /> },
  { name: "shopping", icon: <FaShoppingCart /> },
  { name: "travel", icon: <ImAirplane />},
  { name: "study", icon: <GiOpenBook /> },
  { name: "health", icon: <MdHealthAndSafety /> },
  { name: "saving", icon: <MdSavings /> },
  { name: "fitness", icon: <MdFitnessCenter /> },
  { name: "family", icon: <MdFamilyRestroom />},
  { name: "insuranse", icon: <AiOutlineFileProtect /> },
  { name: "", icon: <ImDroplet /> },
  { name: "", icon: <ImEarth /> },
  { name: "", icon: <ImFire /> },
  { name: "", icon: <ImAttachment /> },
  { name: "", icon: <ImClubs /> },
  { name: "", icon: <ImHammer /> },
  { name: "", icon: <ImHourGlass /> },
  { name: "", icon: <ImManWoman /> },
  { name: "", icon: <ImMusic /> },
  { name: "", icon: <ImPhone /> },
  { name: "", icon: <ImStarFull /> },
  { name: "", icon: <ImHeart /> },
  { name: "", icon: <MdOfflineBolt />},
  { name: "", icon: <MdNearMe /> },
  { name: "", icon: <MdKitesurfing />},
  { name: "", icon: <MdIcecream /> },
  { name: "", icon: <MdChildFriendly />},
];
export const Home = () => {
  return (
    <svg
